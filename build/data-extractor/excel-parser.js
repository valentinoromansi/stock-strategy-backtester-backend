...
function getAllCsvData() {
    ...
    return new Promise(function (resolve, rej) { return __awaiter(_this, void 0, void 0, function () {
        var fileNames, allParsedCsv, i, _a, _b;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0: return [4 /*yield*/, getFileNames(yml_1.yml.excelPath)];
                case 1:
                    fileNames = _c.sent();
                    allParsedCsv = [];
                    i = 0;
                ...
                case 2:
                    ...
                    _b = (_a = allParsedCsv).push;
                    return [4 /*yield*/, getParsedCsv(yml_1.yml.excelPath + "/" + fileNames[i])];
                case 3:
                    _b.apply(_a, [_c.sent()]);
                    _c.label = 4;
                case 4:
