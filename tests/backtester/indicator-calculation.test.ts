...
test("emaValue must properly calculate ema4 value", () => {
  let prices: PriceLinkedList = new PriceLinkedList()
  prices.append(new Price(new Date(), 0, 8, 0, 0))
  prices.append(new Price(new Date(), 0, 13, 0, 0))
  prices.append(new Price(new Date(), 0, 6, 0, 0))
  prices.append(new Price(new Date(), 0, 9, 0, 0)) //                 4 => sma =>  (8 + 13 + 6 + 9) / 4 =    9
  prices.append(new Price(new Date(), 0, 12, 0, 0)) //                5 => ema => (12 - 9) * 0.4 + 9 =       10.2
  prices.append(new Price(new Date(), 0, 5, 0, 0)) //                6 => ema => (5 - 10.2) * 0.4 + 10.2 =  8.12
  const price = prices.append(new Price(new Date(), 0, 22, 0, 0)) //  7 => ema => (22 - 8.12) * 0.4 + 8.12 =  13.67
